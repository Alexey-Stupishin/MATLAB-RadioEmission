...
data.XCEN = ((index.naxis1+1)/2 - index.crpix1)*index.cdelt1 + index.crval1;
data.YCEN = ((index.naxis2+1)/2 - index.crpix2)*index.cdelt2 + index.crval2;
...
data.trim.DATA_TRIM.X = 1:sz(2);
data.trim.DATA_TRIM.Y = 1:sz(1);
data.trim.DATA_DT = 0;
