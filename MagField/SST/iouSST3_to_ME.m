function [B, index] = iouSST3_to_ME(file_pattern, saveit)
...
B.absB = fitsread(ffield);
B.incl = fitsread(fincl)*180/pi;
B.azim = 180 - fitsread(fazim)*180/pi;
